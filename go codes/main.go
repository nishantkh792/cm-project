// // it has all the nested json parsing code , best code.
// //it also has server/server.go main code before creating directories internal/kbb
package main
